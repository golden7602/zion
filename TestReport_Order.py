...
class Order(JPReport):
    ...
    def _init_ReportHeader(self,title1="NOTA DE PAGAMENTO",title2="(ESTE DOCUMENTO É DO USO INTERNO)"):
        ...
        RH.AddItem(1,
                ...
                AlignmentFlag=(Qt.AlignTop | Qt.AlignHCenter | Qt.AlignHCenter),
                Bolder=False)
        # 第1行
        RH.AddItem(1,
                0,
    ...
    def _init_ReportHeader_Individualization(self):
        ...
        RH.AddPrintLables(
            ...
            155,
            20, [
                "#", "数量Qtd", "名称Descrição", "长Larg.", "宽Comp.", "单价P. Unitario",
                "金额Total"
    ...
    def _init_DetailAndPageHeader(self):
        ...
        PH.AddItem(1,
                ...
                Font=self.font_Algerian_11,
                AlignmentFlag=(Qt.AlignTop | Qt.AlignVCenter | Qt.AlignHCenter),
                Bolder=False)
        # 第1行
        PH.AddItem(1,
                0,
        ...
        self.Detail.AddPrintFields(
            ...
            0,
            20, [
                "fQuant", "fQuant", "fProductName", "fLength", "fWidth", "fPrice"
    ...
    def PrintCurrentReport(self,OrderID:str="CP2019-0201000021"):
        ...
        data.sort(key=lambda x: (x['fCustomerName'], x['fCity'], x['fAmount'] is
                                None, x['fAmount']))
