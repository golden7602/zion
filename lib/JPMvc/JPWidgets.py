...
from PyQt5.QtCore import QDate, QObject, Qt, pyqtSignal, QPropertyAnimation, QPoint
...
from PyQt5.QtWidgets import QDialog as QDialog_
...
class DialogAnimation(QDialog_):
