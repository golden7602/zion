...
CREATE  VIEW `v_enumeration` AS select t.fTypeID,t.fTypeName,e.fItemID,e.fTitle,e.fSpare1,e.fSpare2,e.fNote from t_enumeration_type as t left join t_enumeration as e on t.fTypeID=e.fTypeID ;
...
CREATE  VIEW `v_quotation` AS select o.fOrderID,
o.fPrice,
o.fCustomerID,
o.fOrderDate,
o.fEspecieID,
