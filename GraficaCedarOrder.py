...
class JPMainWindow(QMainWindow):
    def __init__(self):
        ...
        self.ui.label_Title.setText("Grafic Cedar OrderM")
        self.setWindowTitle("Grafic Cedar OrderM")

        self.icoPath = getcwd() + "\\res\\ico\\{}"
        self.logoPath = getcwd() + "\\res\\{}"

        # 设置主窗体中按钮图标及Logo
        self.logoPixmap = QPixmap(self.logoPath.format("tm_cedar100.png"))
        self.backPixmap = QPixmap(self.logoPath.format("tm_cedar1624.png"))
