...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.setTabOrder(self.butTaxCer, self.fNUIT)
        ...
        Form.setTabOrder(self.fLogo, self.fEspecieID)
        Form.setTabOrder(self.fEspecieID, self.fCelular)
        Form.setTabOrder(self.fCelular, self.fTelefone)
        Form.setTabOrder(self.fTelefone, self.fAvistaID)
        Form.setTabOrder(self.fAvistaID, self.fTamanhoID)
        Form.setTabOrder(self.fTamanhoID, self.fVendedorID)
        Form.setTabOrder(self.fVendedorID, self.fQuant)
        Form.setTabOrder(self.fQuant, self.fPrice)
        Form.setTabOrder(self.fPrice, self.fNrCopyID)
        Form.setTabOrder(self.fNrCopyID, self.fPagePerVolumn)
