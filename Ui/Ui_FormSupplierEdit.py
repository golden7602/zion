...
# Form implementation generated from reading ui file 'e:\Zion\zion\Ui\FormSupplierEdit.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.fSupplierName = QtWidgets.QLineEdit(Form)
        self.fSupplierName.setMinimumSize(QtCore.QSize(0, 25))
        self.fSupplierName.setSizeIncrement(QtCore.QSize(0, 25))
        self.fSupplierName.setClearButtonEnabled(True)
        self.fSupplierName.setObjectName("fSupplierName")
        self.gridLayout.addWidget(self.fSupplierName, 1, 1, 1, 1)
        ...
        self.fSupplierID = QtWidgets.QLineEdit(Form)
        self.fSupplierID.setMinimumSize(QtCore.QSize(0, 25))
        self.fSupplierID.setSizeIncrement(QtCore.QSize(0, 25))
        self.fSupplierID.setReadOnly(True)
        self.fSupplierID.setClearButtonEnabled(True)
        self.fSupplierID.setObjectName("fSupplierID")
        self.gridLayout.addWidget(self.fSupplierID, 0, 1, 1, 1)
        ...
        Form.setTabOrder(self.fSupplierID, self.fSupplierName)
        Form.setTabOrder(self.fSupplierName, self.fEndereco)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_18.setText(_translate("Form", "供应商信息"))
        self.label_19.setText(_translate("Form", "Supplier Information"))
        self.label_13.setText(_translate("Form", "客户编号SupplierID:"))
        self.label_7.setText(_translate("Form", "税号NUIT:"))
        self.label_6.setText(_translate("Form", "客户名称SupplierName:"))
