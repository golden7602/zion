...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.butNew = QtWidgets.QPushButton(self.frame_2)
        self.butNew.setObjectName("butNew")
        self.horizontalLayout.addWidget(self.butNew)
    ...
    def retranslateUi(self, Form):
        ...
        self.butNew.setText(_translate("Form", "New"))
