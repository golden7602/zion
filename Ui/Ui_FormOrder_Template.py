...
# Form implementation generated from reading ui file 'e:\Zion\zion\Ui\FormOrder_Template.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_Title_Note.setAlignment(QtCore.Qt.AlignHCenter
                                           | QtCore.Qt.AlignTop)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../res/ico/Print.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, Form):
        ...
        self.fCustomerID.setToolTip(
            _translate(
                "Form",
                "<html><head/><body><p>可输入客户名称或税号中的部分或全部进行快速过滤</p><p>Enter part or all of the customer name or tax number for quick filtering</p></body></html>"
            ))
        ...
        self.tableView.setToolTip(
            _translate(
                "Form",
                "<html><head/><body><p>如果要输入单价为金额为0的订单，请在单价处输入0，但这时，明细表只能输入一行，如果要增加行，请先点击表格空白处（取消选中任何单元格），然后按 alt+d。</p><p>If you want to enter an order with a unit price of 0, please enter 0 at the unit price. But at this time, the detailed list can only enter one line. If you want to add more rows, please click on the blank of the table (cancel any cells), and then press Alt + D.</p></body></html>"
            ))
